...
import confirm from "@m/_confirm/_confirm.js";
...
import uploadImg from "@c/imgHandler/imgHandler";
...
const advancedProfile = (user) => {
    ...
    const editPasswordButton = $(".edit-password");

    saveEditButton.addEventListener("click", () => saveEdit(profileText, form));
    cancelEditButton.addEventListener("click", () => closeEdit(profileText, form));
    ...
    editPasswordButton.addEventListener("click", () => changePassword());
};
